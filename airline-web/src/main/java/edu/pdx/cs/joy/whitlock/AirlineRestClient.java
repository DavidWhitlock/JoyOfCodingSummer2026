...
public class AirlineRestClient
{
  ...
  public void addFlight(String airline, int flightNumber) throws IOException {
    Response response = http.post(Map.of(
      AirlineServlet.AIRLINE_NAME_PARAMETER, airline,
      AirlineServlet.FLIGHT_NUMBER_PARAMETER, String.valueOf(flightNumber))
    );
    throwExceptionIfNotOkayHttpStatus(response);
  }
